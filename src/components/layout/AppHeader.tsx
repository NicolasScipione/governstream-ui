...
export function AppHeader() {
  return (
    <header className="h-14 bg-header flex items-center justify-between px-6 border-b border-sidebar-border">
      {/* Logo and App Name */}
      <div className="flex items-center gap-3">
        <div className="w-8 h-8 bg-header-foreground/20 rounded-md flex items-center justify-center">
          <span className="text-header-foreground font-bold text-sm">CD</span>
        </div>
        <div className="flex flex-col">
          <span className="text-header-foreground font-semibold text-sm leading-tight">
            Ciudadano Digital
          </span>
          <span className="text-header-foreground/70 text-xs leading-tight">
      ...
      <div className="flex-1 max-w-md mx-8">
        <div className="relative">
          ...
          <Input
            placeholder="Buscar solicitudes, usuarios..."
            className="pl-9 bg-header-foreground/10 border-header-foreground/20 text-header-foreground placeholder:text-header-foreground/50 h-9"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="ghost" size="icon" className="text-header-foreground/80 hover:text-header-foreground hover:bg-header-foreground/10 relative">
          ...
          <span className="absolute top-1 right-1 w-2 h-2 bg-status-pending rounded-full"></span>
        </Button>
